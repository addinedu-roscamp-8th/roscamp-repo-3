...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'jetcobot_ws/src/jetcobot1/jetcobot_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'jetcobot_ws/install/jetcobot_moveit_config/share/jetcobot_moveit_config/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='jetcobot',
...
def generate_launch_description():
    ...
    urdf_filename = 'jetcobot.urdf.xacro'
    rviz_config_filename = 'jetcobot_description.rviz'
